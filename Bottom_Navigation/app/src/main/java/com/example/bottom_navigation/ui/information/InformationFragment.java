...
public class InformationFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        groups = new String[] { "Common Steps", "FAQ", "Lost and Found Office"};

        children = new String [][] {
                { "1. I \n2. Love \n3. Rice" },
                { "Q1: I lost my phone, where should I go? \nA1: GTFO \nQ2: Where is the nearest lost and found office? \nA2: My house" },
                { "1. Killer Hall \n2. Lind Hall \n3. Mechanical Engineering Building \n4. Coffeeman \n5. Moos Tower \n6. Starbucks" }
        };
    }
